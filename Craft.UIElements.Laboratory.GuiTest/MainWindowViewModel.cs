using Craft.UIElements.Laboratory.GuiTest.Tab1;
using Craft.UIElements.Laboratory.GuiTest.Tab2;
using Craft.UIElements.Laboratory.GuiTest.Tab3;
using Craft.UIElements.Laboratory.GuiTest.Tab4;
using Craft.UIElements.Laboratory.GuiTest.Tab5;
using GalaSoft.MvvmLight;

namespace Craft.UIElements.Laboratory.GuiTest
{

...
public class MxCifQuadTreeTest
{
    ...
    public void Test01_Insert12Rectangles_And_CheckForIntersectionWithAnother()
    {
        ...
        // Act
        var mxCifQuadTree1 = new MxCifQuadTree<Line>(new BoundingBox(0, 100, 0, 100), logger);
    ...
    public void Test04_TimingTest_WithRectangles()
    {
        ...
        var mxCifQuadTree = new MxCifQuadTree<Line>(new BoundingBox(0, 100, 0, 100), new DummyLogger());
    ...
    public void Test05_FunWithMaxDepth()
    {
        ...
        // Arrange
        var spatialItem1 = new SpatialItem<Line>(new BoundingBox(4.25, 8.25, 4.25, 8.25), new Line());
        var spatialItem2 = new SpatialItem<Line>(new BoundingBox(4.25, 8.25, 4.25, 8.25), new Line());
    ...
    public void Test06_TimingTest_MaxDepth()
    {
        ...
        var spatialItemQueue = new Queue<SpatialItem<Line>>();
        var mxCifQuadTree = new MxCifQuadTree<Line>(new BoundingBox(0, 100, 0, 100), 3, logger);
    ...
    public void Test07_Insert_Tricky_Horizontal_Line_No_Axis_Intersections()
    {
        ...
        // Arrange
        var spatialItem1 = new SpatialItem<Line>(new BoundingBox(5, 10, 2.5, 2.5), new Line());

        // Act
        var mxCifQuadTree1 = new MxCifQuadTree<Line>(new BoundingBox(0, 100, 0, 100), 3, logger);
        mxCifQuadTree1.Insert(spatialItem1);
        logger.Complete();
    }
    ...
    public void Test08_Insert_Tricky_Horizontal_Line_Intersecting_Y_Axis()
    {
        ...
        // Arrange
        var spatialItem1 = new SpatialItem<Line>(new BoundingBox(10, 15, 5, 5), new Line());
    ...
    public void Test09_Insert_Tricky_Vertical_Line_Intersecting_x_Axis()
    {
        ...
        // Arrange
        var spatialItem1 = new SpatialItem<Line>(new BoundingBox(5, 5, 10, 15), new Line());
    ...
    public void Test10_Insert_Tricky_Horizontal_Line()
    {
        ...
        // Arrange
        var spatialItem1 = new SpatialItem<Line>(new BoundingBox(22.5, 27.5, 5, 5), new Line());
    ...
    public void Test11_Insert_Tricky_Lines_Then_Remove_Them_Again()
    {
        ...
        // Arrange
        //var spatialItem1 = new SpatialItem<Line>(new BoundingBox(5, 10, 2.5, 2.5), new Line());
        var spatialItem2a = new SpatialItem<Line>(new BoundingBox(10, 15, 5, 5), new Line());
        var spatialItem2b = new SpatialItem<Line>(new BoundingBox(10, 15, 5, 5), new Line());
        //var spatialItem3 = new SpatialItem<Line>(new BoundingBox(5, 5, 10, 15), new Line());
        //var spatialItem4 = new SpatialItem<Line>(new BoundingBox(22.5, 27.5, 5, 5), new Line());
    ...
    public void Test12_TimingTest_WithPoints()
    {
        ...
        var spatialItemQueue = new Queue<SpatialItem<Line>>();
        var maxDepth = 3;
        var mxCifQuadTree = new MxCifQuadTree<Line>(new BoundingBox(0, 100, 0, 100), maxDepth, new DummyLogger());
